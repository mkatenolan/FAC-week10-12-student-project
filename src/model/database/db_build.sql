BEGIN;
  ...
  CASCADE;
DROP TABLE IF EXISTS junction_plans_recipes
CASCADE;
DROP TABLE IF EXISTS recipes
CASCADE;
DROP TABLE IF EXISTS junction_recipes_ingredients
CASCADE;
...
INSERT INTO recipes
  (id, recipe_name, instructions, cooking_time, health_score)
VALUES
  ( 0,
    'Easy Shrimp Risotto',
...
INSERT INTO junction_plans_recipes
  (plan_id, recipe_id)
VALUES
...
INSERT INTO junction_recipes_ingredients
